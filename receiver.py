...
class udpServerThread(QtCore.QThread):
    ...
    def run(self):
        ...
        self.updateState.emit(("message", "<b><font color='green'>MESSAGE:&nbsp;</font></b>找到发送者: <b>" + address[
            0] + "</b>&nbsp;&nbsp;<b><font color='red'>准备接收文件, 点[接收]</font></b>"))
...
class tcpServerThread(QtCore.QThread):
    ...
    def run(self):
        ...
        self.updateState.emit(
            ("message", "<b><font color='blue'>MESSAGE:&nbsp;</font></b>等待发送者建立连接, 端口:<b>" + str(self.caller.TCPPort)))
        ...
        self.updateState.emit(
            ("message", "<b><font color='green'>MESSAGE:&nbsp;</font></b>成功与: <b>" + str(senderAddr) + "建立连接</b>"))
        ...
        print("receiver", "client is going to send:",
              data.decode("utf-8").strip())  # =======================================================================
        self.updateState.emit(
            ("message", "<b><font color='blue'>MESSAGE:&nbsp;</font></b>发送方有" + str(len(files)) + "个文件发送"))
        ...
        for i in range(len(self.fileDesc)):  # 元组列表, 每个元组表示一个文件的文件名与大小
            try:
                ...
                self.updateState.emit(("message",
                                       "<b><font color='blue'>MESSAGE:&nbsp;</font></b><font color='green'>开始接收:" + str(
                                           self.fileDesc[0][0]) + "</font>"))
                ...
                if hasRecv == fileSize:
                    ...
                    self.updateState.emit(("message",
                                           "<b><font color='green'>MESSAGE:&nbsp;</font></b><font color='green'>完成接收:" + str(
                                               self.fileDesc[0][0]) + "  耗时:" + str(
